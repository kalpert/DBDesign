...
INSERT INTO `posts` VALUES (2,'asdas','2015-05-01 00:00:00',NULL,1),(4,'tb12 baby','2015-12-02 00:00:00',NULL,1);
...
INSERT INTO `posttopics` VALUES (4,'pats');
...
INSERT INTO `topics` VALUES ('pats');
...
INSERT INTO `users` VALUES (1,'Kut','kurt.marcink@gmail.com','pbkdf2:sha1:1000$cS1mWWwR$a2bcd2a6c498716a76da3381fb3ce145c187e467',NULL);
...
BEGIN
	INSERT INTO posts (author, body, timestamp) VALUES (auth, bod, ts);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2015-12-02 15:55:35
